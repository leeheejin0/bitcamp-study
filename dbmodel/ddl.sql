...
ALTER TABLE ems_tch
  MODIFY COLUMN mno INTEGER NOT NULL AUTO_INCREMENT COMMENT '강사번호';
...
ALTER TABLE ems_room_photo
  ADD CONSTRAINT PK_ems_room_photo -- 강의실 사진 기본키
    PRIMARY KEY (
      pno -- 사진번호
    );
...
-- 강의실 사진
ALTER TABLE ems_room_photo
  ADD CONSTRAINT FK_ems_room_TO_ems_room_photo -- 강의실 -> 강의실 사진
    FOREIGN KEY (
      crno -- 강의실번호
    )
    REFERENCES ems_room ( -- 강의실
